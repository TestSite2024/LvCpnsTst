...
window.onload = async () => {
    ...
    var catText =  ["Picnic in the Park","Dance Class","Karaoke Night","Bookstore Adventure","Wine Tasting","Volunteer Together","Memory Lane Trip","Visit an Art Gallery","Photo Shoot Session","Photo Booth Fun","Karaoke Night","Bike Ride","Escape Room","Farmers' Market Visit","Cooking Class","Museum Exploration","Dance Class","Fishing Excursion","Concert Date","Visit a Botanical Garden","Pottery Class","Zoo Day","Horseback Riding","Yoga Together","Train Ride","Theater or Musical","Movie Theater","Beer Tasting","Games at a Café","Sunset Cruise","Visit a Comedy Club","Play a Sport Together","Antique Shopping","Weekend Staycation","Cultural Festival","Bird Watching","Carnival Games","VR Challenge","Laser Tag Battle","Paintball Battle"];
    var couponText = ["Pack a picnic basket and enjoy each other's company in a beautiful outdoor setting"];
    var a = new Image();
    ...
    var functionFinished = function() {
        ...
        message_popup(catText[0],couponText[0]);
        wheel.spinTo(1);
        wheel.isSpinning=0;
        finishedSpin=true;
    };
    ...
    window.addEventListener('click', (e) => {
      ...
      if (e.target === btn) {
        ...
        wheel.spinToItem(0, duration, true, randomInRangeint(1,2) ,1, easeOutCubic);
...
var Wheel = class {
    ...
    dragEnd() {
        ...
        this.refreshCursor(), e > 90 && this.spinToItem(0, duration, true, randomInRangeint(1,2) ,1, easeOutCubic);// && this.beginSpin(e * (1e3 / 250), "interact")
    }
