...
window.onload = async () => {
    ...
    var catText =  ["Rock Climbing","Zip Lining","Hiking Date","Camping Trip","Road Trip","Amusement Park","Winter Sports","Hot Air Balloon","Rafting Ride","Visit a Water Park"];
    var couponText = ["Scale new heights together at an indoor rock climbing gym"];
    var a = new Image();
