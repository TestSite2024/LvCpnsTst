...
window.onload = async () => {
    ...
    var catText =  ["DIY Pizza Night","Fondue Night", "Cooking Challenge", "Master Chef", "Bake and Decorate", "Ice Cream Sundae Bar", "Brunch Buffet", "Cheese and Wine", "International Cuisine", "Foodie Road Trip", "Food Truck Adventure", "Dessert Buffet", "High Tea at Home","Cocktail Mixing Night","Tapas Tour", "Camping Cookout","Vegetarian Feast", "Chocolate Date","DIY Smoothie Bar","Crepes for Dinner"];
    var couponText = ["Make personalized pizzas with your favorite toppings at home"];
    var a = new Image();
