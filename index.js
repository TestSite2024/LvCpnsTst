...
window.onload = async () => {
    ...
    document.addEventListener(
        "visibilitychange",
         function(evt) {
          ...
          if (document.visibilityState != "visible" && wheel.isSpinning==1&& finishedSpin==false) {
            wheel.spinTo(1);
            wheel.isSpinning=0;
            finishedSpin=true;
            }
    ...
    window.addEventListener('click', (e) => {
      ...
      if (e.target === btn) {        
        ...
        wheel.spinToItem(0, duration, true, 10 ,1, easeOutCubic);
...
var Wheel = class {
    ...
    dragEnd() {
        ...
        this.refreshCursor(), e > 90 && this.spinToItem(0, duration, true, 10 ,1, easeOutCubic);
    }
