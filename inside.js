...
var finishedSpin = false;
 ...
 window.onload = async () => {
    ...
    var couponText = ["","Pamper each other with a relaxing massage for a soothing and intimate experience. Use Massage oils with scent"];
    var a = new Image();
    ...
    var functionFinished = function() {
        ...
        message_popup(catText[1],couponText[1]);
        wheel.spinTo(1);
        wheel.isSpinning=0;
        finishedSpin=true;
    };
    ...
    window.addEventListener('click', (e) => {
      ...
      if (e.target === btn) {
        ...
        wheel.spinToItem(1, duration, true, 1 ,1, easeOutCubic);
...
var Wheel = class {
    ...
    dragEnd() {
        ...
        this.refreshCursor(), e > 90 && this.spinToItem(1, duration, true, 1 ,1, easeOutCubic);// && this.beginSpin(e * (1e3 / 250), "interact")
    }
